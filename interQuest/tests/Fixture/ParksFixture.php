...
class ParksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rank' => ['type' => 'string', 'length' => 25, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'tax_type' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => 'flat', 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'sector_id' => 1,
            'midreign' => '2016-09-30',
            'coronation' => '2016-09-30',
            'tax_rate' => 1.5,
            'tax_type' => 'Lorem ip',
            'created' => '2016-09-30 00:42:55',
            'modified' => '2016-09-30 00:42:55',
            'deleted' => '2016-09-30 00:42:55'
        ],
    ];
}
