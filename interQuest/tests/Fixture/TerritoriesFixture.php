...
class TerritoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'primary_resource' => ['type' => 'string', 'length' => 11, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'secondary_resource' => ['type' => 'string', 'length' => 11, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_no_mans_land' => 1,
            'has_road' => 1,
            'created' => '2016-09-30 00:43:05',
            'modified' => '2016-09-30 00:43:05'
        ],
    ];
}
