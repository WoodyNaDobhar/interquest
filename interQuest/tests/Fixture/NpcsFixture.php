...
class NpcsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'private_name' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'grain' => 1,
            'action_id' => 1,
            'deceased' => '2016-09-30 00:42:53',
            'created' => '2016-09-30 00:42:53',
            'modified' => '2016-09-30 00:42:53',
            'deleted' => '2016-09-30 00:42:53'
        ],
    ];
}
