...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <h3 class="panel-title"><?= h($monster->name) ?></h3>
    </div>
    <table class="table table-striped" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td><?= __('Personable') ?></td>
            <td><?= $monster->personable ? __('Yes') : __('No'); ?></td>
        </tr>
        <tr>
            <td><?= __('Description') ?></td>
            <td><?= $this->Text->autoParagraph(h($monster->description)); ?></td>
        </tr>
    </table>
</div>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($monster->npcs)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($monster->npcs as $npcs): ?>
                <tr>
                    <td><?= h($npcs->id) ?></td>
                    <td><?= h($npcs->name) ?></td>
...
<div class="panel panel-default">
    ...
    <?php if (!empty($monster->personas)): ?>
        <table class="table table-striped">
            ...
            <tbody>
            <?php foreach ($monster->personas as $personas): ?>
                <tr>
                    <td><?= h($personas->id) ?></td>
