...
class EquipmentsController extends AppController
{
    ...
    public function view($id = null)
    {
        $equipment = $this->Equipments->get($id, [
            'contain' => ['Buildings', 'Npcs', 'Personas']
        ]);
    ...
    public function add()
    {
        ...
        $buildings = $this->Equipments->Buildings->find('list', ['limit' => 200]);
        $npcs = $this->Equipments->Npcs->find('list', ['limit' => 200]);
        $personas = $this->Equipments->Personas->find('list', ['limit' => 200]);
        $this->set(compact('equipment', 'buildings', 'npcs', 'personas'));
        $this->set('_serialize', ['equipment']);
    }
