...
class TerritoriesController extends AppController
{
    ...
    public function view($id = null)
    {
        $territory = $this->Territories->get($id, [
            'contain' => ['Sectors', 'Terrains', 'Buildings', 'Personas', 'Comments', 'EquipmentsNpcs', 'EquipmentsPersonas', 'Fieves', 'Npcs']
        ]);
    ...
    public function add()
    {
        ...
        $sectors = $this->Territories->Sectors->find('list', ['limit' => 200]);
        $terrains = $this->Territories->Terrains->find('list', ['limit' => 200]);
        $buildings = $this->Territories->Buildings->find('list', ['limit' => 200]);
        $this->set(compact('territory', 'sectors', 'terrains', 'buildings'));
        $this->set('_serialize', ['territory']);
    }
