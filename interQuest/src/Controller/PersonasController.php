...
class PersonasController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Users', 'Vocations', 'Monsters', 'Npcs', 'Parks', 'Territories']
        ];
    ...
    public function view($id = null)
    {
        $persona = $this->Personas->get($id, [
            'contain' => ['Users', 'Vocations', 'Monsters', 'Npcs', 'Parks', 'Territories', 'Actions', 'Fieves', 'Equipments', 'Titles', 'Comments', 'Fiefdoms']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('persona', 'users', 'vocations', 'monsters', 'npcs', 'parks', 'territories', 'actions', 'fieves', 'equipments', 'titles'));
        $this->set('_serialize', ['persona']);
    }
