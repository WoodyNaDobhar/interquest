...
class BuildingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->allowEmpty('resource_required');

        $validator
            ->allowEmpty('building_required');

        $validator
            ->boolean('waterway_required')
            ->requirePresence('waterway_required', 'create')
            ->notEmpty('waterway_required');
