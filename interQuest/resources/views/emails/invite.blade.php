...
<html xmlns="http://www.w3.org/1999/xhtml"
		xmlns:v="urn:schemas-microsoft-com:vml"
				...
				<title>You Are Invited...to Quest!</title>
						...
						<tr>
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
											...
											<td>
											<!-- Head -->
													<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#605ca8">
													<tr>
															<td>
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
															...
															<td>
																...
																<div class="h3-2-center" style="color:#1e1e1e; font-family:Arial, sans-serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center; letter-spacing:5px">YOU'VE RECEIVED</div>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
											<tr>
												...
												<td>
													...
													<div class="h3-1-center" style="color:#1e1e1e; font-family:Georgia, serif; min-width:auto !important; font-size:20px; line-height:26px; text-align:center"><a href="#" target="_blank" class="link" style="color:#a88123; text-decoration:none"><span class="link" style="color:#a88123; text-decoration:none"><?php echo $inviter->persona->name; ?></span></a> has invited you to join <?php echo $inviter->persona->park->name; ?> in using InterQuest!</div>
													<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="30" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
														...
														<tr>
															...
															<td>
																...
																<div class="h5-1-center" style="color:#a88123; font-family:Georgia, serif; min-width:auto !important; font-size:16px; line-height:26px; text-align:center">
																	<a href="#" target="_blank" class="link" style="color:#a88123; text-decoration:none"><span class="link" style="color:#a88123; text-decoration:none"><?php echo $inviter->persona->name; ?></span></a>
																</div>
																<table width="100%" border="0" cellspacing="0" cellpadding="0" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%"><tr><td height="20" class="spacer" style="font-size:0pt; line-height:0pt; text-align:center; width:100%; min-width:100%">&nbsp;</td></tr></table>
																	...
																	<tr>
																		<td align="center">
																			<table width="210" border="0" cellspacing="0" cellpadding="0">
																				<tr>
																					<td align="center" bgcolor="#605ca8">
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<th class="column-top" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top; Margin:0" valign="top" width="40">
																<table width="100%" border="0" cellspacing="0" cellpadding="0">
																	<tr>
																		<td><div style="font-size:0pt; line-height:0pt;" class="mobile-br-20"></div>
</td>
																	</tr>
																</table>
															</th>
