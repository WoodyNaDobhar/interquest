...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('commented_id', old('commented_id'), ['class' => 'form-control']) !!}
</div>

<!-- Commented Type Field -->
<div class="form-group col-sm-6">
    {!! Form::label('commented_type', 'Commented Type:') !!}
    {!! Form::text('commented_type', old('commented_type'), ['class' => 'form-control']) !!}
</div>

<!-- Author Persona Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('author_persona_id', 'Author Persona Id:') !!}
    {!! Form::number('author_persona_id', old('author_persona_id'), ['class' => 'form-control']) !!}
</div>
