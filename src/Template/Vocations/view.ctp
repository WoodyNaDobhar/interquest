...
<div class="vocations view large-9 medium-8 columns content">
    <h3><?= h($vocation->name) ?></h3>
    ...
    <div class="row">
        <h4><?= __('Ability Description') ?></h4>
        <?= $this->Text->autoParagraph(h($vocation->ability_description)); ?>
    </div>
    <div class="related">
