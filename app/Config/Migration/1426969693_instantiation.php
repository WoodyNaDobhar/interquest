	...
	public $migration = array(
		'up' => array(
			'create_table' => array(
				...
				'fieves_npcs' => array(
					'fief_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'length' => 10, 'unsigned' => true, 'key' => 'primary'),
				...
				'personas_titles' => array(
					'persona_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'length' => 10, 'unsigned' => true, 'key' => 'primary'),
					'title_id' => array('type' => 'integer', 'null' => false, 'default' => null, 'length' => 10, 'unsigned' => true, 'key' => 'index'),
					'indexes' => array(
		...
		'down' => array(
			'drop_table' => array(
				'actions', 'buildings', 'comments', 'equipments', 'fiefdoms', 'fieves', 'fieves_npcs', 'fieves_personas', 'monsters', 'npcequipments', 'npcs', 'parks', 'personaactions', 'personaequipments', 'personas', 'personas_titles', 'playclasses', 'sectors', 'terrains', 'territories', 'territorybuildings', 'titles'
			),
		),
	);
