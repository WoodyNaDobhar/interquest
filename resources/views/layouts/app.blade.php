					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown user user-menu">
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<img src="{!! $userPersona ? $userPersona->likeness : '/img/profile.png' !!}"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header">
									<img src="{!! $userPersona ? $userPersona->likeness : '/img/profile.png' !!}" class="img-circle" alt="{!! $userPersona && $userPersona->long_name ? $userPersona->long_name : Auth::user()->name !!}"/>
									<p>
